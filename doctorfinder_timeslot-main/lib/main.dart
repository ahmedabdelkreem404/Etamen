...
/// old url
const String SERVER_ADDRESS = "http://127.0.0.1:8002";
const String IMAGE = "http://127.0.0.1:8002/public/upload/banner/";
...
String STRIPE_KEY = const String.fromEnvironment('STRIPE_KEY', defaultValue: '');
String TOKENIZATION_KEY = const String.fromEnvironment('BRAINTREE_TOKENIZATION_KEY', defaultValue: '');
String RAZORPAY_KEY = const String.fromEnvironment('RAZORPAY_KEY', defaultValue: '');
