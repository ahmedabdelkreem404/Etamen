        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text(
                DOCTOR_DASHBOARD,
                style: Theme.of(context).textTheme.headlineSmall!.apply(color: Theme.of(context).scaffoldBackgroundColor,
                fontWeightDelta: 5
                )
              )
            ],
                          ...
                          Row(
                            children: [
                              Text(doctorProfileWithRating!.data!.departmentName!.isEmpty ? SPECIALITY : doctorProfileWithRating!.data!.departmentName!,
                                style: Theme.of(context).textTheme.bodyLarge!.apply(color: Theme.of(context).primaryColorDark),
                              ),
                              SizedBox(width: 10,),
                              Image.asset(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5,),
                        Text(list[index].status, style: Theme.of(context).textTheme.bodySmall!.apply(
                          fontSizeDelta: 0.5,
                          fontWeightDelta: 2,
                        ),),
                        SizedBox(width: 5,),
