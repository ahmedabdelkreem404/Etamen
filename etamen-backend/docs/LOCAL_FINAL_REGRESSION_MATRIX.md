...
| Pharmacy MVP smoke | PASS | Conservative smoke/MVP coverage; no new Sprint 61 feature. |
| Lab MVP smoke | PASS | Conservative smoke/MVP coverage; no new Sprint 61 feature. |
...
| Pharmacy/lab read-only MVP | PASS | Conservative provider MVP where lifecycle is not fully expanded. |
