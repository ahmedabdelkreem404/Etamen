...
use App\Modules\Radiology\Policies\RadiologyPreparationInstructionPolicy;
use App\Modules\Radiology\Policies\RadiologyOrderPolicy;
use App\Modules\Radiology\Policies\RadiologyResultPolicy;
use App\Modules\Radiology\Policies\RadiologyScanCategoryPolicy;
use App\Modules\Radiology\Policies\RadiologyScanPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(RadiologyScanCategory::class, RadiologyScanCategoryPolicy::class);
        Gate::policy(RadiologyScan::class, RadiologyScanPolicy::class);
        Gate::policy(RadiologyPreparationInstruction::class, RadiologyPreparationInstructionPolicy::class);
        Gate::policy(RadiologyOrder::class, RadiologyOrderPolicy::class);
        Gate::policy(RadiologyResult::class, RadiologyResultPolicy::class);
