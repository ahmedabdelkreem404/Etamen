...
use App\Filament\Resources\PharmacyProfileResource\Pages;
...
class PharmacyProfileResource extends Resource
{
    protected static ?string $model = PharmacyProfile::class;
    ...
    {
        return [
            'index' => Pages\ManagePharmacyProfiles::route('/'),
        ];
    }
}
