...
use App\Filament\Resources\ClinicProfileResource\Pages;
...
class ClinicProfileResource extends Resource
{
    protected static ?string $model = ClinicProfile::class;
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TextInput::make('clinic_type'),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('clinic_type')->searchable(),
    ...
    {
        return [
            'index' => Pages\ManageClinicProfiles::route('/'),
        ];
    }
}
