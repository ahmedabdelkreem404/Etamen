...
use App\Filament\Resources\AppointmentStatusHistoryResource\Pages;
use App\Modules\Appointments\Infrastructure\Models\AppointmentStatusHistory;
use Filament\Forms;
...
class AppointmentStatusHistoryResource extends Resource
{
    protected static ?string $model = AppointmentStatusHistory::class;
    ...
    {
        return [
            'index' => Pages\ManageAppointmentStatusHistories::route('/'),
        ];
    }
}
