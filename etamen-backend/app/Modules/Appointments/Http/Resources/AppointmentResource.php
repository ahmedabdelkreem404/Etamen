...
class AppointmentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'hospital_doctor_id' => $this->hospital_doctor_id,
            'booked_through_hospital' => $this->hospital_provider_id !== null,
            ...
            'hospital' => $this->whenLoaded('hospital', fn () => [
                'id' => $this->hospital?->id,
                'name_ar' => $this->hospital?->name_ar,
                'name_en' => $this->hospital?->name_en,
            ]),
            'department' => $this->whenLoaded('hospitalDepartment', fn () => [
                'id' => $this->hospitalDepartment?->id,
                'name_ar' => $this->hospitalDepartment?->name_ar,
                'name_en' => $this->hospitalDepartment?->name_en,
            ]),
