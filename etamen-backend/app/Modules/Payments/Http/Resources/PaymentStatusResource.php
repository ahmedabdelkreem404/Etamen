...
class PaymentStatusResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'lab_order' => $this->whenLoaded('payable', function () {
                if (! $this->payable || ! str_ends_with((string) $this->payable_type, 'LabOrder')) {
                    return null;
                }
            ...
            'radiology_order' => $this->whenLoaded('payable', function () {
                if (! $this->payable || ! str_ends_with((string) $this->payable_type, 'RadiologyOrder')) {
                    return null;
                }
