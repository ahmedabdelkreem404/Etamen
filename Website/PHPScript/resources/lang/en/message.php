<?php 
   ...
   return [
         "RTL"=>"1", // 0=>RTL ,1=>LTR
   		...
   		"System Name"=>"اطمّن | Etamen",
   		"Log In"=>"Log In",
   		"meta_description"=>"اطمّن — صحتك متتابعة",
   		"Meta Keyword"=>"Etamen,اطمّن,Book Appointment,Fast Appointment",
         ...
         "Find A Doctor"=>"اطمّن على صحتك",
         "Amet consectetur adipisicing elit sed do eiusmod"=>"اطمّن — صحتك متتابعة",
